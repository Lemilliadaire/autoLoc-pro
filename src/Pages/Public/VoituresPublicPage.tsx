...
import { Search, FunnelFill, GeoAltFill, Speedometer, Calendar, Palette, XCircle } from "react-bootstrap-icons";
            ...
            <Card className="border-0 shadow-sm sticky-top" style={{ top: '2rem', zIndex: 1 }}>
              <Card.Body className="p-4">
                <div className="d-flex justify-content-between align-items-center mb-4">
                  ...
                  {(search || categorieId || agenceId || statut !== 'disponible') && (
                    ...
                    <Col key={v.id}>
                      <Card className="h-100 border-0 shadow-sm card-hover">
                        <div className="position-relative">
                          ...
                          <Badge
                            bg={v.statut === 'disponible' ? 'success' : 'warning'}
                        ...
                        <Card.Body className="p-4">
                          ...
                          <div className="d-flex justify-content-between align-items-center pt-3 border-top">
                            <div>
                              <span className="h4 fw-bold text-primary mb-0">{v.prix_journalier} €</span>
